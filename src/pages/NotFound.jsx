  ...
  return (
    <main className="not-found-page not-found-page--realistic">
      ...
      <header className="not-found__brand-block">
        <Link to="/" className="not-found__logo-link" aria-label="Return to Golden Wings Home">
        ...
        <div className="not-found__title-row">
          ...
          <div className="not-found__headline-wrap">
            <h1 className="not-found__headline">Part Not Found in Flight Manifest</h1>
          </div>
        </div>
      </header>
      ...
      <section className="not-found__bottom-controls">
        <form className="not-found__search-form" onSubmit={handleSearch}>
          ...
          <input
            type="text"
            placeholder="Search:  (e.g. 212-040-004-3)"
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            aria-label="Search aircraft parts inventory"
          />
          <button type="submit" className="not-found__search-btn" aria-label="Search part">
            <span>Find Part</span>
