...
function Header() {
  ...
  return (
    <>
      ...
      {/* Responsive Dropdown Menu (Opens at the bottom) */}
      <div
        className={`site-header__mobile-dropdown ${isMobileMenuOpen ? 'is-open' : ''}`}
        aria-hidden={!isMobileMenuOpen}
      >
        <div className="site-header__mobile-card">
          ...
          <div className="site-header__mobile-bottom">
            <NavLink
              to="/contact"
              className="site-header__quote-btn site-header__quote-btn--mobile"
              onClick={() => setIsMobileMenuOpen(false)}
            >
      ...
      <div className={`site-header-wrapper ${!isVisible ? 'site-header-wrapper--hidden' : ''} ${isMobileMenuOpen ? 'is-menu-open' : ''}`}>
